...
<div class="photo-box">
  ...
  <span class="highlight-photo-tooltip">The tattoo-pen drawing represents my existence rooted on Earth, which can be broken down into fundamental particles of nature bound together with limitless energy, which emerges from the underlying mathematical reality of the unbounded universe.</span>
</div>
<section id="intro" class="bp-grid-3">
  ...
  <div class="photo-me">
    ...
    <picture>
      ...
      <img src="/static/images/main/me.jpeg" loading="lazy" alt="Profile pic" width="200" height="224" class="-mt-3" />
    </picture>
  </div>
</section>
#+end_export

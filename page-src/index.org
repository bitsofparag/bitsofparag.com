...
<section id="intro" class="bp-grid-3">
  <div class="col-span-2">
    ...
    <p class="intro">Please <a href="https://cal.com/paragm/30min">book a 30min call</a> or connect via the options below.</p>
  </div>
  <div class="photo-me">
    <picture>
...
-
     ...
     #+end_export
- {{{extlink(https://cal.com/paragm/30min, Book a call, rel="me")}}}

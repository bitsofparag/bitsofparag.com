...
<section id="intro" class="bp-grid-3">
  <div class="col-span-2">
    <p class="intro">Software developer. Entrepreneur. Ex Director of Software Engineering.</p>
    <p class="intro">🌿 <strong>Building digital solutions</strong> to tackle challenges in EU's green energy transition.</p>

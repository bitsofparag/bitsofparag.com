...
Compared to previous-day bread:

{{{img(/static/images/breaking-bread/25052020-slices-2.jpg, width:400px;)}}}

- *Dough:*
  Clearly, the gluten structure was strong because of higher than usual proportion of white flour.
...
- *Baking*
  After pre-heating at 250°C, I set the final dough over a tray of boiling water
...
- *Taste and texture*
  Definitely in the top three of what I've made so far (/which would be six/),
...
- *Presentation*
  I was confident that the scoring would work this time. It looked very
...
** Verdict
  ...
  - *Dough:* Soft and wet dough. Super easy to knead, stretch and fold.
  The soaked chia seeds probably increased the hydration beyond 70%. The
